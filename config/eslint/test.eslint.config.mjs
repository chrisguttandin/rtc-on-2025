...
export default defineConfig([
    ...
    },
    {
        files: ['**/*.ts'],
        rules: {
            '@angular-eslint/component-selector': ['error', { prefix: 'rto', style: 'kebab-case', type: 'element' }],
            '@angular-eslint/directive-selector': ['error', { prefix: 'rto', style: 'camelCase', type: 'attribute' }],
